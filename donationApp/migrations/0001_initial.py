# Generated by Django 4.0.6 on 2022-07-11 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='donationApp.charity')),
                ('donor_id', models.ManyToManyField(blank=True, to='donationApp.donor')),
            ],
        ),
        migrations.AddField(
            model_name='charity',
            name='donor',
            field=models.ManyToManyField(blank=True, to='donationApp.donor'),
        ),
        migrations.AddField(
            model_name='charity',
            name='user',
